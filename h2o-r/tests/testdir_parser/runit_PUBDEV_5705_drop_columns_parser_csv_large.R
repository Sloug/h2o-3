...
test.parseSkippedColumns<- function() {
  ...
  # assertCorrectSkipColumns(fileName, fullFrameR, skip10Per, TRUE) # test importFile
  # assertCorrectSkipColumns(fileName, fullFrameR, skip10Per, FALSE) # test uploadFile
  # 
