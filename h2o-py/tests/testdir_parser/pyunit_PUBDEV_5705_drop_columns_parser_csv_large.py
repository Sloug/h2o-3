...
def test_csv_parser_column_skip():
  ...
  # skip even columns
  checkCorrectSkips(f1, savefilenamewithpath, skip_even)

  # skip odd columns
  checkCorrectSkips(f1, savefilenamewithpath, skip_odd)

  # skip the very beginning and the very end.
  checkCorrectSkips(f1, savefilenamewithpath, skip_start_end)

  # skip all except the last column
  checkCorrectSkips(f1, savefilenamewithpath, skip_except_last)

  # skip all except the very first column
  checkCorrectSkips(f1, savefilenamewithpath, skip_except_first)

  # randomly skipped half the columns
  checkCorrectSkips(f1, savefilenamewithpath, skip_random)
